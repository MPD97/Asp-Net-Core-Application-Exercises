...
namespace _04_CRUD.Controllers
{
    public class ShopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ShopId,Name,Created")] Shop shop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShopId,Name,Created")] Shop shop)
        {
            if (id != shop.ShopId)
            {
                return NotFound();
